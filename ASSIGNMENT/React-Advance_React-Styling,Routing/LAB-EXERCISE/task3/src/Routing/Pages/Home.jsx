        ...
        <div id="carouselExampleCaptions" className="carousel slide mb-1">
          ...
          <div className="carousel-inner">
            <div className="carousel-item active">
              <img
                src="https://tse4.mm.bing.net/th/id/OIP.ktz8eFWP2nnAWh3ax7bbaQHaEw?pid=Api&P=0&h=180"
            ...
            <div className="carousel-item">
              <img
                src="https://tse2.mm.bing.net/th/id/OIP.eoXwXrKjli2AKzFxwRgk8AHaE8?pid=Api&P=0&h=180"
                style={{ height: "500px", objectFit: "cover" }}
                className="d-block w-100"
                alt="..."
              />
      ...
      <section className="container my-5">
        ...
        <div className="row align-items-center mb-5">
          <div className="col-md-6">
            <img
              src="https://tse3.mm.bing.net/th/id/OIP.f6ved8wranJjaO8g0qDStgHaEK?pid=Api&P=0&h=180"
