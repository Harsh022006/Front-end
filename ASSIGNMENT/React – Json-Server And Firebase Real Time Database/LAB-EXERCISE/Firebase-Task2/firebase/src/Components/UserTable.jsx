                                        ...
                                        <td>
                                            <div className="d-flex align-items-center gap-3">
                                                ...
                                                <MDBTooltip tag="span" title="Edit this user">
                                                    <Link onClick={() => editUserHandler(value)} to="/edituser" className="d-flex flex-column align-items-center text-success text-decoration-none">
                                                        <MDBIcon fas icon="user-edit" className='fs-4' />
                                                        <small>Update</small>
                                                    </Link>
                                                </MDBTooltip>
                                                ...
                                                <MDBTooltip tag="span" title="Delete this user">
                                                    <Link onClick={() => deleteUser(value)} to="" className="d-flex flex-column align-items-center text-danger text-decoration-none">
                                                        <MDBIcon fas icon="user-times" className="fs-4" />
                                                        <small>Delete</small>
                                                    </Link>
                                                </MDBTooltip>
                                            </div>
